...
class Merlin_Customizer_Importer {
	...
	public static function import( $customizer_import_file_path ) {
		...
		if ( is_wp_error( $results ) || empty( $results ) ) {
			write_log('Error customize import file option');
			return false;
		}
	...
	public static function import_customizer_options( $import_file_path ) {
		...
		if ( ! file_exists( $import_file_path ) ) {
			write_log('Error: The customizer import file is missing! File path: '.$import_file_path);
			return new \WP_Error(
		...
		if ( ! is_array( $data ) && ( ! isset( $data['template'] ) || ! isset( $data['mods'] ) ) ) {
			write_log('Error: The customizer import file is not in a correct format. Please make sure to use the correct customizer import file.');
			return new \WP_Error(
		...
		if ( $data['template'] !== $template ) {
			write_log('Error: The customizer import file is not suitable for current theme. You can only import customizer settings for the same theme or a child theme.');
			return new \WP_Error(
