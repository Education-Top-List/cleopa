        ...
        <div class="featured-gallery swiper-container">
            <div class="swiper-wrapper">
                ...
                if ( has_post_thumbnail() ) {
					...
					$html .= '<a class="prettyphoto" data-rel="prettyPhoto[rel-'.$post->ID.']" href="'.$full_size_image[0].'">';
                    $html .= get_the_post_thumbnail( $post->ID, 'shop_single', $attributes );
                    $html .= '</a>';
                    $html .= '</div>';
                } else {
                    $html  = '<div class="woocommerce-product-gallery__image--placeholder">';
					$html .= '<a class="prettyphoto" data-rel="prettyPhoto[rel-'.$post->ID.']" href="'.esc_url( wc_placeholder_img_src() ).'">';
                    $html .= sprintf( '<img src="%s" alt="%s" class="wp-post-image" />', esc_url( wc_placeholder_img_src() ), esc_html__( 'Awaiting product image', 'cleopa' ) );
                    $html .= '</a>';
                    $html .= '</div>';
                }
                ...
                if ( $attachment_ids && has_post_thumbnail() ) {
                    foreach ( $attachment_ids as $attachment_id ) {
                        ...
                        $html .= '<a class="prettyphoto" data-rel="prettyPhoto[rel-'.$attachment_id.']" href="'.$full_size_image[0].'">';
