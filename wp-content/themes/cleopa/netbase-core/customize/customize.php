...
class Cleopa_Customize
{
    ...
    public static function register($wp_customize)
    {
        ...
        $customize_arr = new Cleopa_Customize_Options();
        ...
        foreach($customize_options as $section => $define) {
            ...
            foreach($options as $option => $option_define) {
                $default_arr = cleopa_default_options();
    ...
    public static function customize_control_js()
    {
        ...
        wp_enqueue_script('nbcore-customizer-control', get_template_directory_uri() . '/assets/netbase/js/admin/control.min.js', array('customize-controls', 'jquery'), Cleopa_VER, true);
        wp_enqueue_script('nbcore-customize', get_template_directory_uri() . '/assets/netbase/js/admin/customize.min.js', array('jquery'), Cleopa_VER, true);
    ...
    {
        //this is minified version
        wp_enqueue_script('nbcore_customizer_preview', get_template_directory_uri() . '/assets/netbase/js/admin/preview.min.js', array('customize-preview', 'jquery'), Cleopa_VER, true);
    }
    ...
    {
        //this is minified version
        wp_enqueue_style('nbcore_customizer_style', get_template_directory_uri() . '/assets/netbase/css/admin/customizer/customizer.css', NULL, Cleopa_VER, 'all');
    }
